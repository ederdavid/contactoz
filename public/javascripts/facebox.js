...
(function($) {
  ...
  $.extend($.facebox, {
    ...
    reveal: function(data, klass) {
      ...
      if (klass) $('#facebox .content-face').addClass(klass)
      $('#facebox .content-face').append(data)
  ...
  $(document).bind('close.facebox', function() {
    ...
    $('#facebox').fadeOut(function() {
      $('#facebox .content-face').removeClass().addClass('content-face')
      hideOverlay()
      $('#facebox .loading').remove()
    })
  })
