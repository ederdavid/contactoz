...
if (typeof renderTwitters != 'function') (function () {
    ...
    function relative_time(time_value) {
        ...
        if (delta < 5) {
            r = '<span>less than 5 seconds ago</span>';
        } else if (delta < 30) {
            r = '<span>half a minute ago</span>';
        } else if (delta < 60) {
            r = '<span>less than a minute ago</span>';
        } else if (delta < 120) {
            r = '<span>1 minute ago</span>';
        } else if (delta < (45*60)) {
            r = '<span>' + (parseInt(delta / 60)).toString() + ' minutes ago</span>';
        } else if (delta < (2*90*60)) { // 2* because sometimes read 1 hours ago
            r = '<span>about 1 hour ago</span>';
        } else if (delta < (24*60*60)) {
            r = '<span>about ' + (parseInt(delta / 3600)).toString() + ' hours ago</span>';
        } else {
            if (delta < (48*60*60)) {
                r = '<span>'+formatTime(date) + ' yesterday</span>';
            } else {
                r = '<span>'+formatTime(date) + ' ' + formatDate(date) + '</span>';
